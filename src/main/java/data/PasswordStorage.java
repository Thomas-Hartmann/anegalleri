...
public class PasswordStorage
{
    ...
    public static boolean validateHash(String password){
        // Decode the hash into its parameters
        String[] params = password.split(":");
        System.out.println("params: "+params.length);
        if (params.length != HASH_SECTIONS) return false;
        // Currently, Java only supports SHA1.
        if (!params[HASH_ALGORITHM_INDEX].equals("sha1")) return false;
        ...
        if (storedHashSize != hash.length) return false;
